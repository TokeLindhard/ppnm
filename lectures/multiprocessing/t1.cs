...
class main{
    ...
    public static void Main(string[] args){
        ...
        t1.Start(x); //here program runs in three threads, one main and t1 and t2.
        t1.Join(); //here all threads have joined up again into the main thread.
        WriteLine($"harm sum from {1} to {N} is equal {x.sum}");
    }
}